...
public class ComponentRoseGroupingElse extends AbstractTextualComponent {
	...
	public ComponentRoseGroupingElse(HtmlColor fontColor, HtmlColor hyperlinkColor, HtmlColor groupBorder, UFont smallFont, CharSequence comment,
			ISkinSimple spriteContainer, HtmlColor backgroundColor, UStroke stroke) {
		super(comment == null ? null : "[" + comment + "]", fontColor, hyperlinkColor, smallFont, HorizontalAlignment.LEFT, 5, 5, 1,
				spriteContainer, 0);
