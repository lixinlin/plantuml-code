...
public class Macro {
	...
	public static ST_Agnode_s AGTAIL(__ptr__ e) {
		return (ST_Agnode_s) AGMKIN(e).getPtr("node");
	}
	...
	public static ST_Agnode_s AGHEAD(__ptr__ e) {
		return (ST_Agnode_s) AGMKOUT(e).getPtr("node");
	}
	...
	public static __ptr__ GD_parent(ST_Agraph_s g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getPtr("parent");
	}

	public static void GD_parent(ST_Agraph_s g, __ptr__ v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setPtr("parent", v);
	}
	...
	public static int GD_charset(ST_Agraph_s g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getInt("charset");
	}

	public static void GD_charset(ST_Agraph_s g, int v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setInt("charset", v);
	}

	// #define GD_has_labels(g) (((Agraphinfo_t*)AGDATA(g))->has_labels)
	public static int GD_has_labels(__ptr__ g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getInt("has_labels");
	}

	public static void GD_has_labels(__ptr__ g, int v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setInt("has_labels", v);
	}
	...
	public static int GD_has_flat_edges(ST_Agraph_s g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getInt("has_flat_edges");
	}

	public static void GD_has_flat_edges(ST_Agraph_s g, boolean v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setBoolean("has_flat_edges", v);
	}
	...
	public static double GD_ht1(ST_Agraph_s g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getDouble("ht1");
	}

	public static void GD_ht1(ST_Agraph_s g, double v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setDouble("ht1", v);
	}

	// #define GD_ht2(g) (((Agraphinfo_t*)AGDATA(g))->ht2)
	public static double GD_ht2(ST_Agraph_s g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getDouble("ht2");
	}

	public static void GD_ht2(ST_Agraph_s g, double v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setDouble("ht2", v);
	}
	...
	public static int GD_n_cluster(ST_Agraph_s g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getInt("n_cluster");
	}

	public static void GD_n_cluster(ST_Agraph_s g, int v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setInt("n_cluster", v);
	}

	// #define GD_n_nodes(g) (((Agraphinfo_t*)AGDATA(g))->n_nodes)
	public static int GD_n_nodes(ST_Agraph_s g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getInt("n_nodes");
	}

	public static void GD_n_nodes(ST_Agraph_s g, int v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setInt("n_nodes", v);
	}
	...
	public static ST_Agnode_s GD_nlist(ST_Agraph_s g) {
		return (ST_Agnode_s) AGDATA(g).castTo(ST_Agraphinfo_t.class).getPtr("nlist");
	}

	public static void GD_nlist(ST_Agraph_s g, __ptr__ v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setPtr("nlist", v);
	}

	// #define GD_nodesep(g) (((Agraphinfo_t*)AGDATA(g))->nodesep)
	public static int GD_nodesep(ST_Agraph_s g) {
		return AGDATA(g).castTo(ST_Agraphinfo_t.class).getInt("nodesep");
	}

	public static void GD_nodesep(ST_Agraph_s g, int v) {
		AGDATA(g).castTo(ST_Agraphinfo_t.class).setInt("nodesep", v);
	}
	...
	public static int ND_id(ST_Agnode_s n) {
		return AGDATA(n).castTo(ST_Agnodeinfo_t.class).getInt("id");
	}

	// #define ND_alg(n) (((Agnodeinfo_t*)AGDATA(n))->alg)
	public static __ptr__ ND_alg(ST_Agnode_s n) {
		return AGDATA(n).castTo(ST_Agnodeinfo_t.class).getPtr("alg");
	}

	public static void ND_alg(ST_Agnode_s n, __ptr__ value) {
		AGDATA(n).castTo(ST_Agnodeinfo_t.class).setPtr("alg", value);
	}

	// #define ND_UF_parent(n) (((Agnodeinfo_t*)AGDATA(n))->UF_parent)
	public static ST_Agnode_s ND_UF_parent(__ptr__ n) {
		return (ST_Agnode_s) AGDATA(n).castTo(ST_Agnodeinfo_t.class).getPtr("UF_parent");
	}

	public static void ND_UF_parent(__ptr__ n, __ptr__ v) {
		AGDATA(n).castTo(ST_Agnodeinfo_t.class).setPtr("UF_parent", v);
	}
	...
	public static int ND_UF_size(ST_Agnode_s n) {
		return AGDATA(n).castTo(ST_Agnodeinfo_t.class).getInt("UF_size");
	}

	public static void ND_UF_size(ST_Agnode_s n, int v) {
		AGDATA(n).castTo(ST_Agnodeinfo_t.class).setInt("UF_size", v);
	}
	...
	public static ST_Agraph_s ND_clust(__ptr__ n) {
		return (ST_Agraph_s) AGDATA(n).castTo(ST_Agnodeinfo_t.class).getPtr("clust");
	}

	public static void ND_clust(ST_Agnode_s n, __ptr__ v) {
		AGDATA(n).castTo(ST_Agnodeinfo_t.class).setPtr("clust", v);
	}

	// #define ND_coord(n) (((Agnodeinfo_t*)AGDATA(n))->coord)
	public static ST_pointf ND_coord(__ptr__ n) {
		return (ST_pointf) AGDATA(n).castTo(ST_Agnodeinfo_t.class).getStruct("coord");
	}
	...
	public static ST_elist ND_flat_in(ST_Agnode_s n) {
		return (ST_elist) AGDATA(n).castTo(ST_Agnodeinfo_t.class).getStruct("flat_in");
	}

	// #define ND_flat_out(n) (((Agnodeinfo_t*)AGDATA(n))->flat_out)
	public static ST_elist ND_flat_out(ST_Agnode_s n) {
		return (ST_elist) AGDATA(n).castTo(ST_Agnodeinfo_t.class).getStruct("flat_out");
	}
	...
	public static boolean ND_has_port(ST_Agnode_s n) {
		return AGDATA(n).castTo(ST_Agnodeinfo_t.class).getBoolean("has_port");
	}
	...
	public static double ND_height(__ptr__ n) {
		return AGDATA(n).castTo(ST_Agnodeinfo_t.class).getDouble("height");
	}

	public static void ND_height(ST_Agnode_s n, double v) {
		AGDATA(n).castTo(ST_Agnodeinfo_t.class).setDouble("height", v);
	}

	// #define ND_hops(n) (((Agnodeinfo_t*)AGDATA(n))->hops)
	// #define ND_ht(n) (((Agnodeinfo_t*)AGDATA(n))->ht)
	public static double ND_ht(__ptr__ n) {
		return AGDATA(n).castTo(ST_Agnodeinfo_t.class).getDouble("ht");
	}

	public static void ND_ht(ST_Agnode_s n, double v) {
		AGDATA(n).castTo(ST_Agnodeinfo_t.class).setDouble("ht", v);
	}
	...
	public static boolean ED_conc_opp_flag(ST_Agedge_s e) {
		return AGDATA(e).castTo(ST_Agedgeinfo_t.class).getBoolean("conc_opp_flag");
	}

	public static void ED_conc_opp_flag(ST_Agedge_s e, boolean v) {
		AGDATA(e).castTo(ST_Agedgeinfo_t.class).setInt("conc_opp_flag", v ? 1 : 0);
	}
	...
	public static void ED_count(__ptr__ e, int v) {
		AGDATA(e).castTo(ST_Agedgeinfo_t.class).setInt("count", v);
	}

	// #define ED_cutvalue(e) (((Agedgeinfo_t*)AGDATA(e))->cutvalue)
	public static int ED_cutvalue(ST_Agedge_s e) {
		return AGDATA(e).castTo(ST_Agedgeinfo_t.class).getInt("cutvalue");
	}

	public static void ED_cutvalue(ST_Agedge_s e, int v) {
		AGDATA(e).castTo(ST_Agedgeinfo_t.class).setInt("cutvalue", v);
	}
	...
	public static int ED_adjacent(__ptr__ e) {
		return AGDATA(e).castTo(ST_Agedgeinfo_t.class).getInt("adjacent");
	}

	public static void ED_adjacent(ST_Agedge_s e, int v) {
		AGDATA(e).castTo(ST_Agedgeinfo_t.class).setInt("adjacent", v);
	}
	...
	public static int ED_showboxes(ST_Agedge_s e) {
		return AGDATA(e).castTo(ST_Agedgeinfo_t.class).getInt("showboxes");
	}

	public static void ED_showboxes(ST_Agedge_s e, int v) {
		AGDATA(e).castTo(ST_Agedgeinfo_t.class).setInt("showboxes", v);
	}
	...
	public static int ED_edge_type(ST_Agedge_s e) {
		return AGDATA(e).castTo(ST_Agedgeinfo_t.class).getInt("edge_type");
	}

	public static void ED_edge_type(ST_Agedge_s e, int v) {
		AGDATA(e).castTo(ST_Agedgeinfo_t.class).setInt("edge_type", v);
	}
	...
	public static void MAKEFWDEDGE(__ptr__ new_, __ptr__ old) {
		...
		info.copyDataFrom(old.getStruct("base").getPtr("data").castTo(ST_Agedgeinfo_t.class).getStruct());
